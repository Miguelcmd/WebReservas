...
function updateFloatingBox(scrollPos) {
    ...
    if (section1Top <= window.innerHeight / 2 && section1Top > -section1.clientHeight / 2) {
        ...
        floatingBox.style.left = '45%'; // Cmbia la posición left
        floatingBox.style.right= '5%';
        ...
        floatingBox.style.left = '1%'; // Ajuste de la posición en x
        floatingBox.style.right= '20%';
        floatingBox.style.backgroundColor = 'rgba(200, 200, 255, 0.8)'; // Otro color de fondo
        floatingBox.style.color = '#000'; // Cambia el color del texto a blanco
        ...
        floatingBox.style.top = '30%'; // Lo ubicamos en la parte inferior
        floatingBox.style.left = '10%'; // Ajuste de la posición en x
        floatingBox.style.right= '56%';
        floatingBox.style.backgroundColor = 'rgba(255, 200, 20, 0.8)'; // Otro color de fondo
